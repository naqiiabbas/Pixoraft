...
/**
 * Brand marks for the social platforms, drawn as inline SVGs (lucide dropped
 * trademarked logos). Shared by the footer and the floating social widget so
 * both render identical icons from one source.
 */
